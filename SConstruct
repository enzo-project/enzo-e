...
# (TEMPORARY) Whether to use new CommBlock-centric control updates
#   versus SimulationCharm
...
if (new_flow != 0):      defines = defines + define_new_flow
