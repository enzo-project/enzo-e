// $Id: parallel_ParallelLayout.cpp 1262 2010-03-03 15:44:05Z bordner $
...
void ParallelLayout::set_process_blocks(int p0, int p1, int p2) throw()
{
  np_[0] = p0;
  np_[1] = p1;
  np_[2] = p2; 
...
void ParallelLayout::set_thread_blocks(int t0, int t1, int t2) throw()
{ 
  nt_[0] = t0;
  nt_[1] = t1;
  nt_[2] = t2; 
...
void ParallelLayout::set_data_blocks(int d0, int d1, int d2) throw()
{ 
  nd_[0] = d0;
  nd_[1] = d1;
  nd_[2] = d2; 
...
int ParallelLayout::data_blocks_per_process () throw()
{ 
...
int ParallelLayout::data_blocks_per_thread () throw()
{
...
void ParallelLayout::box_extent (int ip, int it, int id,
