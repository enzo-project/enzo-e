...
public: // interface
  ...
  int block_count (int *nbx, int *nby = 0, int *nbz = 0) throw();
  ...
  bool is_local (int ip, int ibx, int iby = 0, int ibz = 0) throw();
  ...
  /// Return the process id assigned to the given block
  int process3 (int ibx, int iby=0, int ibz=0)  throw();

  /// Return the 3D indices for the given global block 1D index
  void block_indices (int ib, int * ibx=0, int * iby=0, int * ibz=0) throw();

  /// Return the 3D indices for the given local block 1D index
  void block_indices (int ip, int ib, int * ibx=0, int * iby=0, int * ibz=0) throw();

  /// Return the 1D global index for the given block 3D indices
  int block_index (int ibx, int iby=0, int ibz=0) throw();
