...
#ifndef ENZO_ENZO_RIEMANN_HLLC2_HPP
#define ENZO_ENZO_RIEMANN_HLLC2_HPP
...
using EnzoRiemannHLLC2 = EnzoRiemannImplNew<HLLCKernel>;

#endif /* ENZO_ENZO_RIEMANN_HLLC2_HPP */
