...
std::unique_ptr<chemistry_data_storage> init_rates_(
  ...
  if (local_initialize_chemistry_data(my_chemistry.get_ptr(), out.get(),
                                      grackle_units) == ENZO_FAIL) {
...
void GrackleFacade::setup_grackle_fields(
    const EnzoFieldAdaptor& fadaptor, grackle_field_data* grackle_fields,
  ...
  grackle_fields->internal_energy =
      fadaptor.ptr_for_grackle("internal_energy", true);
  ...
  grackle_fields->RT_HI_ionization_rate =
      fadaptor.ptr_for_grackle("RT_HI_ionization_rate");
  grackle_fields->RT_HeI_ionization_rate =
      fadaptor.ptr_for_grackle("RT_HeI_ionization_rate");
  grackle_fields->RT_HeII_ionization_rate =
      fadaptor.ptr_for_grackle("RT_HeII_ionization_rate");
  grackle_fields->RT_H2_dissociation_rate =
      fadaptor.ptr_for_grackle("RT_H2_dissociation_rate");
...
void GrackleFacade::delete_grackle_fields(
...
void GrackleFacade::solve_chemistry(Block* block, double compute_time,
  ...
  if (local_solve_chemistry(chemistry_data_ptr, grackle_rates_.get(),
                            &grackle_units, &grackle_fields, dt) == ENZO_FAIL) {
...
typedef int (*grackle_local_property_func)(chemistry_data*,
                                           chemistry_data_storage*, code_units*,
                                           grackle_field_data*, enzo_float*);
...
void GrackleFacade::compute_property(
  ...
  if (!grackle_fields) {
    ...
    this->setup_grackle_fields(fadaptor, grackle_fields, stale_depth,
                               omit_cell_width);
  ...
  if ((*(fn_info.ptr))(chemistry_data_ptr, grackle_rates_ptr, &my_units,
                       grackle_fields, values) == ENZO_FAIL) {
