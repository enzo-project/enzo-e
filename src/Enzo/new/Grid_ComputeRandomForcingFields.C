...
extern "C" void FORTRAN_NAME(turboinit)(int *rank, int *nbox,
                          ...
                          long_int *ig, long_int *jg, long_int *kg);

extern "C" void FORTRAN_NAME(turboinit2d)(int *rank, int *nbox,
                          float *u, float *v, 
                          int *in, int *jn, 
                          long_int *ig, long_int *jg);
...
int grid::ComputeRandomForcingFields(int mode)
{
  ...
  if (GridRank > 2)
    ...
    FORTRAN_NAME(turboinit2d)(&GridRank, &nbox, velocity1, velocity2,
