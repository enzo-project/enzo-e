// $Id: enzo_EnzoSimulationCharm.cpp 2074 2011-03-08 01:03:45Z bordner $
...
void EnzoSimulationCharm::run() throw()
{
  ...
  while (! stopping_->complete(cycle,time) ) {
    ...
    ASSERT("EnzoSimulationCharm::run", "dt == 0", dt != 0.0);
...
void EnzoSimulationCharm::write() throw()
{
...
/// @param name   Name of the method to create
{
  ...
  if (method == 0) {
    ...
    ERROR("EnzoSimulationCharm::create_method", buffer);
  }
...
void EnzoSimulationCharm::block_start_ (Block * block) throw ()
{
...
void EnzoSimulationCharm::block_stop_ ( Block * block ) throw ()
{
}

//----------------------------------------------------------------------

void EnzoSimulationCharm::output_images_
(
 Block * block,
...
void EnzoSimulationCharm::deallocate_() throw()
{
  delete enzo_;
  enzo_ = 0;
  delete stopping_;
