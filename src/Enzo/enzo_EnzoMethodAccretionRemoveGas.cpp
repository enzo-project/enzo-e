  ...
  : Method()
{
  ...
  // blocks into density_accreted_accumulate. 
...
void EnzoMethodAccretionRemoveGas::compute_(Block * block)
{
  ...
  // Iterate over active cells, and subtract both density_accreted and
  // density_accreted_accumulate from density
  ...
  // Now set density_accreted and density_accreted_accumulate to zero
  // in all cells.
