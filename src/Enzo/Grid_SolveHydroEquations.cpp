...
/// @author    Greg Bryan
/// @date      November, 1994
/// @todo      Currently EnzoCommBlock::SolveHydroEquations uses field data from enzoDescr (BaryonField, GridStartIndex, etc.); change to use block fields directly to avoid EnzoSimulationSerial::block_begin() copies and repeated boundary condition initialization
...
int EnzoCommBlock::SolveHydroEquations (int CycleNumber, enzo_float time, enzo_float dt)
{
