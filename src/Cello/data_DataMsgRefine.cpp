...
int DataMsgRefine::id_count = -1;
long DataMsgRefine::counter = 0;

DataMsgRefine::~DataMsgRefine()
{
  // if (field_face_) {
  //   delete field_face_;
  //   field_face_ = 0;
...
void * DataMsgRefine::pack (DataMsgRefine * msg)
{

#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgRefine::pack()\n",msg);
#endif
...
DataMsgRefine * DataMsgRefine::unpack(void * buffer)
{
  ...
  DataMsgRefine * msg = (DataMsgRefine *) CkAllocBuffer (buffer,sizeof(DataMsgRefine));
  msg = new ((void*)msg) DataMsgRefine;
#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgRefine::unpack()\n",msg);
#endif
...
void DataMsgRefine::update (Data * data)
{
#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgRefine::update()\n",this);
#endif
  Simulation * simulation = proxy_simulation.ckLocalBranch();
