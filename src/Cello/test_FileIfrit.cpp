...
PARALLEL_MAIN_BEGIN
{
  ...
  FileIfrit ifrit_a("./","test_disk.h5");

  ifrit_a.file_create();

  ifrit_a.file_write_meta(&mx, "mx", type_int);
  ifrit_a.file_write_meta(&my, "my", type_int);

  ifrit_a.group_chdir ("/test");
  ...
  //  ifrit_a.group_create ("/test2/long/long/type/is/long");
  ...
  FileIfrit ifrit_b("./","test_disk.h5");
  ifrit_b.file_open();
  ...
  type = type_unknown;
  ifrit_b.file_read_meta(&b_mx, "mx", &type);

  unit_assert (a_mx == b_mx);
  unit_assert (type == type_int);
  type = type_unknown;
  ifrit_b.file_read_meta(&b_my, "my", &type);
  ...
  type = type_unknown;
  ifrit_b.data_open ("double",&type, &b_nx,&b_ny,&b_nz);
  ...
  type = type_unknown;
  ifrit_b.data_read_meta (&mb_double, "meta_double", &type, &b_mx, &b_my);
  ...
  ifrit_b.group_chdir ("/test");
  ifrit_b.group_open ();

  type = type_unknown;
  ifrit_b.data_open ("char",&type, &b_nx,&b_ny,&b_nz);
  ...
  type = type_unknown;
  ifrit_b.group_read_meta(&g_nx,"nx",&type);
  ifrit_b.group_read_meta(&g_ny,"ny",&type);
  ...
  type = type_unknown;
  ifrit_b.data_read_meta (&mb_char, "meta_char", &type, &b_mx, &b_my);
  ...
  ifrit_b.group_chdir ("/test/int");
  ifrit_b.group_open ();

  type = type_unknown;
  ifrit_b.data_open ("int",&type, &b_nx,&b_ny,&b_nz);
  ...
  type = type_unknown;
  ifrit_b.data_read_meta (&mb_int, "meta_int", &type, &b_mx, &b_my);
  ...
  ifrit_b.group_chdir ("/test2/scalar/long/group");
  ifrit_b.group_open ();

  type = type_unknown;
  ifrit_b.data_open ("float",&type, &b_nx,&b_ny,&b_nz);
  ...
  type = type_unknown;
  ifrit_b.data_read_meta (&mb_float, "meta_float", &type, &b_mx, &b_my);
  ...
  // type = type_unknown;
  // ifrit_b.data_open ("long",&type, &b_nx,&b_ny,&b_nz);
  ...
  // type = type_unknown;
  // ifrit_b.data_read_meta (&mb_long, "meta_long", &type, &b_mx, &b_my);
  ...
  ifrit_b.group_chdir ("/test2/long/long/type/is/long");
  ifrit_b.group_open ();
  
  type = type_unknown;
  ifrit_b.data_open ("long_long",&type, &b_nx,&b_ny,&b_nz);
  ...
  type = type_unknown;
  ifrit_b.data_read_meta (&mb_long_long, "meta_long_long", &type, &b_mx, &b_my);
