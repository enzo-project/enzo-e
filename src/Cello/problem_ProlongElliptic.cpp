...
/// @file     problem_ProlongElliptic.cpp
/// @author   James Bordner (jobordner@ucsd.edu)
/// @date     2013-05-09
/// @brief    Implentation of default elliptic prolongation

#include "problem.hpp"

//----------------------------------------------------------------------

ProlongElliptic::ProlongElliptic() throw()
  : Prolong ()
{
  printf ("ProlongElliptic\n");
  TRACE("ProlongElliptic::ProlongElliptic");
}

//----------------------------------------------------------------------

int ProlongElliptic::apply 
( precision_type precision,
  void *       values_f, int nd3_f[3], int im3_f[3], int n3_f[3],
  const void * values_c, int nd3_c[3], int im3_c[3], int n3_c[3])
{
  TRACE6("ProlongElliptic fine   %d:%d %d:%d %d:%d",
	 im3_f[0],n3_f[0]+im3_f[0],
	 im3_f[1],n3_f[1]+im3_f[1],
	 im3_f[2],n3_f[2]+im3_f[2]);

  TRACE6("ProlongElliptic coarse %d:%d %d:%d %d:%d",
