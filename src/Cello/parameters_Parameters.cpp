...
/// @param    file_name An opened input parameter file or stdin
{
  ...
  // Add in a "mass_is_mass" parameter in the Particle group
  // This is done as a way to identify data generated by a version
  // of the code in which particle "masses" are redefined to be
  // quantities with the dimensions of mass rather than dimensions of
  // density.
  struct param_struct mass_is_mass_param_struct;
  mass_is_mass_param_struct.group[0]  = (char *)"Particle";
  mass_is_mass_param_struct.parameter = (char *)"mass_is_mass";

  // Make it a logical parameter always equal to "true".
  mass_is_mass_param_struct.type = enum_parameter_logical;
  mass_is_mass_param_struct.logical_value = true;

  // Now create a Param object from mass_is_mass_param_struct
  Param mass_is_mass_param;
  mass_is_mass_param.set(&mass_is_mass_param_struct);

  // Call new_param_, which will add this parameter to parameter_map_
  new_param_("Particle:mass_is_mass",&mass_is_mass_param);
