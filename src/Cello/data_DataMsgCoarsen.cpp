...
int DataMsgCoarsen::id_count = -1;
long DataMsgCoarsen::counter = 0;

DataMsgCoarsen::~DataMsgCoarsen()
{
  // if (field_face_) {
  //   delete field_face_;
  //   field_face_ = 0;
...
void * DataMsgCoarsen::pack (DataMsgCoarsen * msg)
{

#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgCoarsen::pack()\n",msg);
#endif
...
DataMsgCoarsen * DataMsgCoarsen::unpack(void * buffer)
{
  ...
  DataMsgCoarsen * msg = (DataMsgCoarsen *) CkAllocBuffer (buffer,sizeof(DataMsgCoarsen));
  msg = new ((void*)msg) DataMsgCoarsen;
#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgCoarsen::unpack()\n",msg);
#endif
...
void DataMsgCoarsen::update (Data * data)
{
#ifdef DEBUG_DATA
  CkPrintf ("DEBUG %p DataMsgCoarsen::update()\n",this);
#endif
  Simulation * simulation = proxy_simulation.ckLocalBranch();
