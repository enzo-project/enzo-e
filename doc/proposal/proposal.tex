...
\note{load-balancing: hierarchical} By \textit{hierarchical load
...
\textbf{Middle}: Balanced octree: 2137 patches.
\textbf{Right}: Balanced octree with coalesced patches: 158 explicit patches.
}
{f:dots}{
\begin{minipage}{7.0in}
\begin{minipage}{2.2in}
