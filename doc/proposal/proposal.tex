...
of hardware parallelism and software data structures.
%
The design will be forward-looking, targeted not just at the largest
existing supercomputers, but also expected future HPC platforms as
...
A wide variety of parallelization technologies will be
