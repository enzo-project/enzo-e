...
\footnotesize
      \begin{itemize}
        \item \ENHANCE{1}Simple quad-tree has level jumps
        \item \ENHANCE{2}Normalize to remove level jumps
        \item \ENHANCE{3}Issues remain:
        \begin{itemize}
\footnotesize
...
\footnotesize
      ...
      \begin{itemize}
\footnotesize
        \item \ENHANCE{3}Fewest patches
	\item \ENHANCE{3}Steep refinement
