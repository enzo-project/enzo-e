%------------------------------------------------------------------------
    \begin{frame}[fragile] \frametitle{Time-stepping optimizations}
...
%------------------------------------------------------------------------
    \begin{frame}[fragile] \frametitle{Time-stepping optimizations}
\begin{itemize}
\enhance{1}\item Adaptive time-stepping \text{within} levels
\enhance{2}\item Avoids global time-step synchronization
\enhance{3}\item Quantize time steps to powers of two
\end{itemize}
\end{frame}
