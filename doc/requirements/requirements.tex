...
% Overview
   ...
   multispecies chemistry, star-formation, magnetohydrodynamics, and radiation
   transfer.
...
% Parallelization: horizontal data movement optimization
   ...
   \textbf{Parallelization levels.}  To take advantage of the
...
%  load balancing
   ...
   \textbf{Dynamic load balancing.}  Multiple levels of parallel tasks
...
\begin{description}
 ...
 \item [Portal (\S\ref{s:output}): ] Output parameters control
