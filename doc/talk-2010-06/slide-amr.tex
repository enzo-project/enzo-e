...
\begin{itemize}
 \enhance{2}\item   coalesce patches to reduce AMR overhead
 \enhance{2}\item   targeted refinement for deep AMR problems
\end{itemize}
\end{itemize}
\end{frame}
...
%--------------------------------------------------
\centerline{\includegraphics[width=3.5in]{coalesce2.png}}
\begin{itemize}
