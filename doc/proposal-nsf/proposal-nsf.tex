...
\SUBSECTION{Targeted refinement}
%
...
%------------------------------------------------------------------------
\SUBSECTION{Implicit global indices}
%
...
\SUBSECTION{Patch-local adaptive time steps}
%
...
\SUBSECTION{Octree AMR data structure}
%
...
%-----------------------------------------------------------------------
\SUBSECTION{Software resilience and self-management.}
