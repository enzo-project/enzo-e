...
\> \> \icode{discret}:     \> \code{int}, $0 \le $ \icode{discret} $\le 2$
\end{tabbing}
\begin{tabbing}
xxxxx\=xxxxx\=xxxxxxxxxxx\=\kill
\> \todo\ \code{solver}  \icode{solver} \\
\> \> \icode{solver}:     \> \code{string} $\in$ \{ ``\code{fac}'', ``\code{pfmg}'' \}
\end{tabbing}
...
\epsfig{file=fig/discret-coarse-4.eps,width=1.5in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sideXP} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sideXP| \axpH \frac{v - U_0}{\frac{3}{4}H_x} \\
...
\begin{minipage}{1.75in}
\epsfig{file=fig/discret-coarse-8.eps,width=1.75in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sideXP} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sideXP| \axpH \frac{v - U_0}{H_x} \\
& = & \frac{H_yH_z}{H_x}  \axpH (\frac{1}{8} \sum_{k=1}^8 u_k - U_0)   \\
\end{eqnarray*}
\end{minipage}

\begin{minipage}{1.75in}
\epsfig{file=fig/discret-fine-1.eps,width=1.36in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sidexp} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sidexp| \axph \frac{V - u_0}{\frac{3}{2}h_x} \\
& = & \frac{h_yh_z}{h_x}  \axph \frac{2}{3} (U_1 - u_0)   \\
\end{eqnarray*}
\end{minipage}

\begin{minipage}{1.75in}
\epsfig{file=fig/discret-fine-3.eps,width=1.75in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sidexp} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sidexp| \axph \frac{V - u_0}{\frac{3}{2}h_x} \\
...
\begin{minipage}{1.75in}
\epsfig{file=fig/discret-fine-4.eps,width=1.75in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sidexp} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sidexp| \axph \frac{V - u_0}{\frac{3}{2}h_x} \\
...
\begin{minipage}{1.75in}
\epsfig{file=fig/discret-fine-6.eps,width=2.25in}
\end{minipage} \ \ \ \ 
\begin{minipage}{4.00in}
\begin{eqnarray*}
 \oint_{\sidexp} \as \nabla \us\cdot \norm \, d\surfel & \approx & |\sidexp| \axph \frac{V - u_0}{\frac{3}{2}h_x} \\
