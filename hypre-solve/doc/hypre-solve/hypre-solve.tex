...
%=======================================================================
\TITLE{Multilevel Linear Solvers in \enzo \\ New (radiation) and Improved (self-gravity)}
      {James Bordner}{$Rev$}
%=======================================================================
...
%======================================================================
\section{Existing \enzo\ Poisson Solver}
%======================================================================
...
\begin{tabbing}
xxx\=xxx\=xxx\=xxx\=xxxxxxxxxxxxxxxxxxxxxxxx\=\kill
\> \codebf{EvolveLevel (LEVEL)} \\
\\
\> \code{SetBoundaryConditions()}   \>\>\>\>  \textit{Update ghost zones} \\
\> \code{GRID.ClearBoundayFluxes()} \>\>\>\>  \textit{Clear boundary fluxes} \\
\> \textit{while} \code{(dtThisLevelSoFar $<$ dtLevelAbove)} \\
\\
\>\>  \code{GRID.ComputeTimeStep()} \\
\>\>  \code{GRID.SetTimeStop()} \\
\>\>  \code{PrepareDensityField(t+0.5*dt)} \\
\>\>  \code{ComputeRandomForcingNormalization()} \\
\\
\>\>  \textit{for} \code{GRID in LEVEL} \\
\\
\>\>\>  \textit{problem-specific analysis} \\
\>\>\>  \code{GRID.SolveForPotential()} \>\>    \textit{self gravity} \\\\
\>\>\>  \code{GRID.ComputeAccelerations()} \\
\>\>\>  \code{GRID.ComputeAccelerationFieldExternal()} \>\> \textit{external gravity} \\
\\
\>          save copy of baryon fields \\
\>          \code{GRID.CopyBaryonFieldToOldBaryonField()} \\
\>          random forcing \\
\>          \code{GRID.AddRandomForcing()} \\
\>          hydrodynamics \\
\>          \code{GRID.SolveHydroEquations()} \\
\>          cooling and multispecies \\
\>             \code{GRID.SolveRateAndCoolEquations()} \\
\>             \code{GRID.SolveRateEquations()} \\
\>             \code{GRID.SolveRadiativeCooling()} \\
\>  \\
\>          update particle positions \\
\>          \code{UpdateParticlePositions(GRID)} \\
\>           \\
\>          include star particle creation and feedback \\
\>             \code{GRID.ZeroSolutionUnderSubgrid()} \\
\>             \code{GRID.StarParticleHandler()} \\
\>  \\
\>          delete acceleration field \\
\>             \code{GRID.DeleteAccelerationField()} \\
\>             \code{GRID.DeleteParticleAcceleration()} \\
\>          update time \\
\>             \code{GRID.SetTimeNextTimestep()} \\
\>          incorporate cosmological expansion terms \\
\>             \code{GRID.ComovingExpansionTerms()} \\
\>       \textit{end} \code{GRID} \\
\>  \\
\>       refresh grid ghost zones \\
\>        \\
\>       \code{SetBoundaryConditions()} \\
\>  \\
\>       update star particle counters \\
\>       \code{CommunicationUpdateStarParticleCount()} \\
\>  \\
\>       movie output \\
\>       \code{WriteMovieData()} \\
\>  \\
\>       tracer particle output \\
\>       \code{WriteTracerParticleData()} \\
\>  \\
\>       recompute gravity for output \\
\>          \code{PrepareDensityField(t+0*dt)} \\
\>          \code{GRID.SolveForPotential()} \\
\>          \code{GRID.CopyPotentialToBaryonField()} \\
\>  \\
\>       output for new level \\
\>          \code{Group\_WriteAllData()} \\
\>          \code{WriteAllData()} \\
\>       output if "outputNow" file exists \\
\>          \code{Group\_WriteAllData()} \\
\>          \code{WriteAllData()} \\
\>       output interpolated data \\
\>          \code{Group\_WriteAllData()} \\
\>          \code{WriteAllData()} \\
\>       output and end if "stopNow" file exists \\
\>          \code{Group\_WriteAllData()} \\
\>          \code{WriteAllData()} \\
\>  \\
\>       stop on request \\
\>          \code{GenerateGridArray()} \\
\>          \code{WriteStreamData()} \\
\>          exit \\
\>  \\
\>       \code{GRID.DeleteGravitatingMassFieldParticles()} \\
\>  \\
\>       \code{EvolveLevel(LEVEL+1)} \\
\>  \\
\>       output streaming movie \\
\>          \code{WriteStreamData()} \\
\>  \\
\>       flux correction \\
\>          \code{CreateSUBlingList()} \\
\>          \code{UpdateFromFinerGrids()} \\
\>          \code{DeleteSUBlingList()} \\
\>  \\
\>       add saved fluxes to subgrid exterior fluxes \\
\>          \code{GRID.AddToBoundaryFluxes()} \\
\>          \code{DeleteFluxes(GRID,SUBGRID)} \\
\>  \\
\>       \code{RadiationFieldUpdate()} \\
\>  \\
\>       \code{RebuildHierarchy()} \\
\>  \\
\>       \code{GRID.CollectGridInformation()} \\
\>  \\
\>    \textit{end while} \\
\>  \\
\>    \code{reportMemoryUsage()} \\
\end{tabbing}
...
%----------------------------------------------------------------------
\subsection{\hypresolve\ \enzo-\hypre interface}
%----------------------------------------------------------------------

   \pargraph{uml of \enzo\ + \hypresolve\ + \hypre}
...
%----------------------------------------------------------------------
\subsection{\hypresolve\ development}
%----------------------------------------------------------------------

%----------------------------------------------------------------------
\subsection{\hypresolve\ interface}
%----------------------------------------------------------------------
