...
flags_arch = '-O3 -Wall -g -ffast-math -funroll-loops -fPIC'
...
flags_arch_fortran = '-ffixed-line-length-132 -Wmaybe-uninitialized -finit-real=snan -ffpe-trap=invalid,zero,overflow'
