...
# this was written to test the legacy checkpoint-restart machinery (based on
# the charm++ infrastructure).
#
# - This does a lot of extra work that, in hindsight, could have been acheived
#   with symlinks
# - all of the test_report machinery stuff was designed to integrate with old
#   testing system that relied on SCons
# - this has largely been replaced by ckpt_restart_test.py, which is designed
#   to test the newer (more scalable) ckpt-restart machinery
