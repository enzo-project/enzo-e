...
def analyze_tests():
    ...
    r.append(standard_rj2a_l1_analyze("x", 256, 0.012524502240005925))
    r.append(standard_rj2a_l1_analyze("x", 256, 0.0, std_dev=True, exact=True))
    r.append(standard_rj2a_l1_analyze("y", 256, 0.012524502240005965))
    r.append(standard_rj2a_l1_analyze("y", 256, 0.0, std_dev=True, exact=True))
    r.append(standard_rj2a_l1_analyze("z", 256, 0.012524502240006053))
