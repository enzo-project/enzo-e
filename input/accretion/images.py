...
# position of the star particle. A series of image files are created, with each image
# corresponding to a particular snapshot. These images are useful to check whether the
...
def make_images(input_prefix,output_prefix):
    ...
    for ds in yt.DatasetSeries(ds_pattern):
        ...
        star_positions = [s for s in zip(box["star","x"],box["star","y"],box["star","z"])]
