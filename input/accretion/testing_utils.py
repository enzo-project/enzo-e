...
# Defines a context manager used by run_accretion_test.py
...
if "/input/accretion" ==  os.path.dirname(os.path.abspath(__file__))[-16:]:
    # this will work even if this file is imported by modifying sys.path 
    _ENZOE_ROOT_DIR = os.path.dirname(os.path.abspath(__file__))[:-16]
else:
    raise RuntimeError("run_accretion_test.py has been moved. "
